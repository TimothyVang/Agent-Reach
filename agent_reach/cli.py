...
def _cmd_install(args):
    ...
    if server_skipped_opencli_channels:
        print()
        print("  -- OpenCLI needs a desktop environment + Chrome; skipped on server: "
    ...
    if not dry_run:
        ...
        if not requested_channels:
            ...
            print("   agent-reach-english install --channels=twitter,xiaohongshu,reddit,facebook,instagram,...")
